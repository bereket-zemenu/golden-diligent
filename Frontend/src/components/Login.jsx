            ...
            <div>
              <div className="relative z-1">
                ...
                <input
                  ...
                  id="phone"
                  placeholder=" "
                  className="relative peer z-1 w-full py-2 pl-[50px] pr-3 border border-blue-500 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />

                {/* Floating Label */}
                <label
                  htmlFor="phone"
                  className="absolute left-[50px] top-1/2 transform -translate-y-1/2 text-gray-500 text-sm transition-all peer-placeholder-shown:translate-y-[-50%] peer-placeholder-shown:text-gray-400 peer-focus:top-[-2px] peer-focus:bg-white peer-focus:px-1 peer-focus:left-[45px] peer-focus:text-blue-500 peer-focus:text-xs"
                >
                  Phone Number
                </label>
